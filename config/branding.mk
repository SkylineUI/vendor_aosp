...
SKYLINEUI_VERSION := 9.0

# Custom Versioning
CUSTOM_VERSION := SkylineUI-v$(SKYLINEUI_VERSION)-$(SKYLINEUI_BASE_VERSION)-$(CUSTOM_PLATFORM_VERSION)-$(CUSTOM_BUILD_DATE)-$(CUSTOM_BUILD)-$(CUSTOM_BUILD_TYPE)
